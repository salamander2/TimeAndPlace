	...
	<div class="card card-dark">
		...
		<div class="box-body">
			<div class="form-group">
				...
				<div class="col "> If checked, then times can be entered for system to automatically sign students out.<br>
				...
				<div class="col ">Show student schedule upon sign-in</div>				
				</div><!-- end row -->
