...
{{-- <input type="checkbox" id="signInOnly" name="signInOnly" {{ $kiosk->signInOnly ? 'checked' :''}}> --}}
                                    ...
                                    <div class="custom-control custom-radio">
                                      <input class="custom-control-input" id="defaultGroupExample1" name="signInOnly" {{ $kiosk->signInOnly ? ''
                                      :'checked'}}  type="radio">
                                    ...
                                    <div class="custom-control custom-radio">
                                      <input class="custom-control-input" id="defaultGroupExample2" name="signInOnly" {{ $kiosk->signInOnly ? 'checked'
                                      :''}} type="radio">
